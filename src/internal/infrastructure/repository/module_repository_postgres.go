...
func (r *PostgresModuleRepository) GetByID(ctx context.Context, id string) (*entity.Module, error) {
...
func (r *PostgresModuleRepository) GetByCourse(ctx context.Context, courseID string) ([]*entity.Module, error) {
...
func (r *PostgresModuleRepository) Delete(ctx context.Context, id string) error {
